      ...
      <motion.div variants={item} className="mb-5">
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-600 to-indigo-800 p-5 text-white shadow-xl shadow-indigo-500/20">
          ...
          <div className="relative z-10 flex gap-4 mt-4 pt-4 border-t border-white/10">
            <div>
              <p className="text-indigo-200 text-xs">Blood Pressure</p>
              <p className="text-white text-sm font-semibold">118/76 mmHg</p>
            </div>
            <div className="w-px bg-white/10" />
            <div>
              <p className="text-indigo-200 text-xs">Resting HR</p>
              <p className="text-white text-sm font-semibold">68 bpm</p>
            </div>
            <div className="w-px bg-white/10" />
            <div>
              <p className="text-indigo-200 text-xs">BMI</p>
              <p className="text-white text-sm font-semibold">22.8</p>
            </div>
          </div>
        </div>
      </motion.div>
